...
class MyFrame3 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"Nutrition Information", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )

		self.m_staticText3.SetFont( wx.Font( 24, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Helvetica" ) )
		...
		self.m_searchCtrl1 = wx.SearchCtrl( self, wx.ID_ANY, wx.EmptyString, wx.Point( -1,-1 ), wx.Size( 300,-1 ), 0|wx.BORDER_DEFAULT, wx.DefaultValidator, u"Search Food Name" )
		self.m_searchCtrl1.ShowSearchButton( True )
		self.m_searchCtrl1.ShowCancelButton( False )
		bSizer8.Add( self.m_searchCtrl1, 0, wx.ALIGN_CENTER|wx.ALL, 5 )

		m_listBox1Choices = []
		self.m_listBox1 = wx.ListBox( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 200,100 ), m_listBox1Choices, 0 )
		bSizer8.Add( self.m_listBox1, 0, wx.ALIGN_CENTER|wx.ALL, 5 )


		bSizer8.Add( ( 0, 0), 1, wx.EXPAND, 5 )

		self.m_button11 = wx.Button( self, wx.ID_ANY, u"Food Search", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer8.Add( self.m_button32, 0, wx.ALIGN_CENTER|wx.ALL, 5 )
		...
		self.m_hyperlink7 = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"Contact", u"http://www.wxformbuilder.org", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
		...
		self.m_hyperlink8 = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"IT Support", u"http://www.wxformbuilder.org", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
		...
		# Connect Events
		self.m_button11.Bind( wx.EVT_BUTTON, self.on_search )
		self.m_button32.Bind( wx.EVT_BUTTON, self.go_to_frame4 )
