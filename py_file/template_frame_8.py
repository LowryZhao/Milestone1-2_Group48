...
class MyFrame8(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_bitmap15 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap(u"Img/logo.png", wx.BITMAP_TYPE_ANY),
        ...
        self.m_staticText7 = wx.StaticText(self, wx.ID_ANY, u"Nutrition Information Plan", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.m_textCtrl4 = wx.TextCtrl(self, wx.ID_ANY,
                                       u"Nutrition Goals:\nxxxxxxxxxxxxxxxxxx\nNutrition Food Item Details:\nxxxxxx\nxxxxx\nNutrition Plan Period:",
                                       wx.DefaultPosition, wx.Size(200, 110), 0)
        bSizer24.Add(self.m_textCtrl4, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        self.m_datePicker1 = wx.adv.DatePickerCtrl(self, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition,
                                                   wx.Size(200, 20), wx.adv.DP_DEFAULT)
        bSizer24.Add(self.m_datePicker1, 0, wx.ALIGN_CENTER | wx.ALL, 5)
        ...
        self.m_hyperlink20 = wx.adv.HyperlinkCtrl(self, wx.ID_ANY, u"Return to HomePage",
                                                  u"http://www.wxformbuilder.org", wx.DefaultPosition, wx.DefaultSize,
                                                  wx.adv.HL_DEFAULT_STYLE)
        self.m_hyperlink20.SetForegroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_HIGHLIGHT))

        bSizer24.Add(self.m_hyperlink20, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        bSizer26 = wx.BoxSizer(wx.HORIZONTAL)

        self.m_hyperlink21 = wx.adv.HyperlinkCtrl(self, wx.ID_ANY, u"Contact", u"http://www.wxformbuilder.org",
        ...
        self.m_hyperlink22 = wx.adv.HyperlinkCtrl(self, wx.ID_ANY, u"IT Support", u"http://www.wxformbuilder.org",
                                                  wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE)
        ...
        bSizer24.Add(bSizer26, 0, wx.ALIGN_RIGHT | wx.ALL, 5)
